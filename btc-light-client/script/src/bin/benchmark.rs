...
use btc_light_client_core::hasher::Keccak256Hasher;
use btc_light_client_core::leaves::get_genesis_leaf;
use btc_light_client_core::light_client::Header;
use btc_light_client_core::mmr::{CompactMerkleMountainRange, MMRProof};
use btc_light_client_core::{BlockPosition, ChainTransition};
use btc_light_client_utils::EXHAUSTIVE_TEST_HEADERS;
use prettytable::{row, Table};
use sp1_sdk::{include_elf, ProverClient, SP1Stdin};
use std::time::Instant;

/// The ELF (executable and linkable format) file for the Succinct RISC-V zkVM.
pub const BTC_LIGHT_CLIENT_ELF: &[u8] = include_elf!("btc-light-client-program");
